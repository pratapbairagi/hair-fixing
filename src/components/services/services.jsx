    ...
    return (
        <>
            <div className=" max-w-[96%] mx-auto flex flex-col col-span-12 px-6 rounded shadow-md py-6 h-max min-h-[80vh]" style={{ fontFamily: "" }}>
                ...
                <p className="text-gray-600 text-md mt-2 min-w-[240px] max-w-[70%] mx-auto">We provide other services except hair fixing. click on each servic to know more details.</p>

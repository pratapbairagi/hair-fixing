...
const Booking = () => {
    ...
    return (
        <>
            <div className="w-full h-max min-h-[125vh] md:min-h-[100vh] bg-gray-100">
                <div className="flex flex-col md:flex-row md:gap-x-3 justify-center items-center relative bg-white w-[90vw] min-h-[82vh] md:min-h-[80vh] left-[5vw] top-[14vh] rounded-md shadow-md  py-6">
                    ...
                    <div className="order-2 md:order-1 h-max min-h-[55vh] md:min-h-[88%] md:w-[65%] w-[78vw] bg-transparent mx-auto md:mx-0 z-10 grid grid-cols-12" style={{ placeContent: "flex-start" }}>
                        ...
                        {/* <fieldset className="col-span-12 md:col-span-12 md:px-2 flex flex-col mt-2 md:mt-3 gap-y-1">
                            ...
                            <textarea type="text" name="details" rows="4" className="block text-sm px-2 py-0.5 text-gray-400 rounded-sm bg-gray-100" />
                        </fieldset> */}
